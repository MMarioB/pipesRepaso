'''
escribe en el padre, se lo envia al hijo, el hijo al nieto y el nieto le envia al hijo y despues al padre una confirmacion
'''
...
if pid > 0:
    ...
    if pid > 0:
        ...
        linea = r2.readline()
        while (linea):
            texto = "CONFIRMADO: " + linea
            os.write(w3, texto.encode(encoding="utf-8"))
            linea = r2.readline()
